...
Data: You can download it from here: https://www.cis.fordham.edu/wisdm/dataset.php                                                                                                                                     
...
Data: I couldn't upload complete data because of it's size, You can download it from here: https://github.com/ieee8023/covid-chestxray-dataset (I have uploaded data set for regression, for classification you can download from the given link)                                                                                                                                      
